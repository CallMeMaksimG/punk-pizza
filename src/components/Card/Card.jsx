    ...
    return (
        <article className="card">
            ...
            <div className="card__pizza-size">
                {sizes && (<ul className="pizza-size__list">
                    {sizes?.map((size, index) => {
                        return (
                            <li onClick={() => onClickSize(index)} className={activeSize === index ? "pizza-size__list-item pizza-size__list-item--active" : "pizza-size__list-item"}>{size} см</li>
                        );
                    })}
                </ul>)}
